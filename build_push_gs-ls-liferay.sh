...
./build_local_image.sh ~/build-custom-liferay-tarball/tarballs/liferay-dxp-gc-ls-liferay-0.8 madhuyadav/gc-ls-liferay 0.8
...
docker push madhuyadav/gc-ls-liferay:0.8
